	...
	$(window).one("resize",function(){//基于框架做的
		$(".add_btn").click(function(){
			var index = layui.layer.open({
				...
				type : 2,
				area: ['800px', '600px'],
				content : "openMedicalScienceAdd",//加载某一张页面
	    ...
	    //do somehing
		 ...
		 //关闭当前提示	
		  ...
		  var index = layui.layer.open({
              ...
              type : 2,
              area: ['800px', '600px'],
              content : "openMedicalScienceEdit?id="+data.id,
