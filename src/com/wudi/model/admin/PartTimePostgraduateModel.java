 ...
 *
 */
public class PartTimePostgraduateModel extends Model<PartTimePostgraduateModel> {
	private static final long serialVersionUID = 1L;
	public static final String tableName = "PartTimePostgraduate";
	public static final PartTimePostgraduateModel dao = new PartTimePostgraduateModel();
	 ...
	 * @return
	 */
	public static Page<PartTimePostgraduateModel> getList(int pageNumber, int pageSize, String key) {
	 ...
	 * @return
	 */
	public static PartTimePostgraduateModel getById(String id) {
	...
	public static boolean save(String id, String name, String sex, String tel_no, String disclose,
		...
		PartTimePostgraduateModel model = new PartTimePostgraduateModel();
	...
	public static boolean update(String id, String name, String sex, String tel_no, String disclose,
			String age,String work_address,String comments,String phone_no,String nation) {
		PartTimePostgraduateModel model = PartTimePostgraduateModel.getById(id);
		if (model == null) {
			return false;
		}
		model.setId(StringUtil.getId());
	 ...
	 * @return
	 */
	public static boolean delPartTimePostgraduateById(String id) {
		try {
	 ...
	 public static List<PartTimePostgraduateModel> findModelbyPhone_no(String phone_no) {
	    	String sql="select * from "+tableName+" where phone_no = ?";
	    	List<PartTimePostgraduateModel> list= dao.find(sql,phone_no);
	    	return list;
	    }
	 public static List<PartTimePostgraduateModel> getListAll() {
