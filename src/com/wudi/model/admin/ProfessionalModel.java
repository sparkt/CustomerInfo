 ...
 *
 */
public class ProfessionalModel extends Model<ProfessionalModel> {
	private static final long serialVersionUID = 1L;
	public static final String tableName = "Professional";
	public static final ProfessionalModel dao = new ProfessionalModel();
	 ...
	 * @return
	 */
	public static Page<ProfessionalModel> getList(int pageNumber, int pageSize, String key) {
	 ...
	 * @return
	 */
	public static ProfessionalModel getById(String id) {
	...
	public static boolean update(String id, String name, String sex, String tel_no, String disclose,
			String age,String work_address,String comments,String phone_no,String nation) {
		ProfessionalModel model = ProfessionalModel.getById(id);
		if (model == null) {
			return false;
		}
		model.setId(StringUtil.getId());
	 ...
	 * @return
	 */
	public static boolean delProfessionalById(String id) {
		try {
	 ...
	 public static List<ProfessionalModel> findModelbyPhone_no(String phone_no) {
	    	String sql="select * from "+tableName+" where phone_no = ?";
	    	List<ProfessionalModel> list= dao.find(sql,phone_no);
	    	return list;
	    }
	 public static List<ProfessionalModel> getListAll() {
