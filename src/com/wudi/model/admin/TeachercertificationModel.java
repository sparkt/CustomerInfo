 ...
 *
 */
public class TeachercertificationModel extends Model<TeachercertificationModel> {
	private static final long serialVersionUID = 1L;
	public static final String tableName = "Teachercertification";
	public static final TeachercertificationModel dao = new TeachercertificationModel();
	 ...
	 * @return
	 */
	public static Page<TeachercertificationModel> getList(int pageNumber, int pageSize, String key) {
	 ...
	 * @return
	 */
	public static TeachercertificationModel getById(String id) {
	...
	public static boolean save(String id, String name, String sex, String tel_no, String disclose,
		...
		TeachercertificationModel model = new TeachercertificationModel();
	...
	public static boolean update(String id, String name, String sex, String tel_no, String disclose,
			String age,String work_address,String comments,String phone_no,String nation) {
		TeachercertificationModel model = TeachercertificationModel.getById(id);
		if (model == null) {
			return false;
		}
		model.setId(StringUtil.getId());
	 ...
	 * @return
	 */
	public static boolean delTeachercertificationById(String id) {
		try {
	 ...
	 public static List<TeachercertificationModel> findModelbyphone_no(String phone_no) {
	    	String sql="select * from "+tableName+" where phone_no = ?";
	    	List<TeachercertificationModel> list= dao.find(sql,phone_no);
	    	return list;
	    }
	 public static List<TeachercertificationModel> getListAll() {
