 ...
 *
 */
public class MandarinModel extends Model<MandarinModel> {
	private static final long serialVersionUID = 1L;
	public static final String tableName = "Mandarin";
	public static final MandarinModel dao = new MandarinModel();
	 ...
	 * @return
	 */
	public static Page<MandarinModel> getList(int pageNumber, int pageSize, String key) {
	 ...
	 * @return
	 */
	public static MandarinModel getById(String id) {
	...
	public static boolean save(String id, String name, String sex, String tel_no, String disclose,
			int age,String work_address,String comments,String phone_no,String nation) {
		MandarinModel model = new MandarinModel();
	...
	public static boolean update(String id, String name, String sex, String tel_no, String disclose,
			int age,String work_address,String comments,String phone_no,String nation) {
		MandarinModel model = MandarinModel.getById(id);
		if (model == null) {
			return false;
		}
		model.setId(StringUtil.getId());
	 ...
	 * @return
	 */
	public static boolean delMandarinById(String id) {
		try {
	 ...
	 public static List<MandarinModel> findModelbyPhone_no(String phone_no) {
	    	String sql="select * from "+tableName+" where phone_no = ?";
	    	List<MandarinModel> list= dao.find(sql,phone_no);
	    	return list;
	    }
	 public static List<MandarinModel> getListAll() {
