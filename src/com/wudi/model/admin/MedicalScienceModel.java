 ...
 *
 */
public class MedicalScienceModel extends Model<MedicalScienceModel> {
	private static final long serialVersionUID = 1L;
	public static final String tableName = "CourtClerk";
	public static final MedicalScienceModel dao = new MedicalScienceModel();
	 ...
	 * @return
	 */
	public static Page<MedicalScienceModel> getList(int pageNumber, int pageSize, String key) {
	 ...
	 * @return
	 */
	public static MedicalScienceModel getById(String id) {
	...
	public static boolean save(String id, String name, String sex, String tel_no, String disclose,
		...
		MedicalScienceModel model = new MedicalScienceModel();
	...
	public static boolean update(String id, String name, String sex, String tel_no, String disclose,
			String age,String work_address,String comments,String phone_no,String nation) {
		MedicalScienceModel model = MedicalScienceModel.getById(id);
		if (model == null) {
			return false;
		}
		model.setId(StringUtil.getId());
	 ...
	 * @return
	 */
	public static boolean delMedicalScienceById(String id) {
		try {
	 ...
	 public static List<MedicalScienceModel> getListAll() {
