 ...
 *
 */
public class SpecialPromotiomModel extends Model<SpecialPromotiomModel> {
	private static final long serialVersionUID = 1L;
	public static final String tableName = "SpecialPromotiom";
	public static final SpecialPromotiomModel dao = new SpecialPromotiomModel();
	 ...
	 * @return
	 */
	public static Page<SpecialPromotiomModel> getList(int pageNumber, int pageSize, String key) {
	 ...
	 * @return
	 */
	public static SpecialPromotiomModel getById(String id) {
	...
	public static boolean save(String id, String name, String sex, String tel_no, String disclose,
		...
		SpecialPromotiomModel model = new SpecialPromotiomModel();
	...
	public static boolean update(String id, String name, String sex, String tel_no, String disclose,
			String age,String work_address,String comments,String phone_no,String nation) {
		SpecialPromotiomModel model = SpecialPromotiomModel.getById(id);
		if (model == null) {
			return false;
		}
		model.setId(StringUtil.getId());
	...
	public static boolean delSpecialPromotiomId(String id) {
	 ...
	 public static List <SpecialPromotiomModel> findModelbyPhone_no(String phone_no) {
	    	String sql="select * from "+tableName+" where phone_no=?";
	    	List<SpecialPromotiomModel> list =dao.find(sql,phone_no);
	    	return list;
	    }
	 public static List<SpecialPromotiomModel> getListAll() {
