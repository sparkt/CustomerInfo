 ...
 *
 */
public class ArchitectModel extends Model<ArchitectModel> {
	private static final long serialVersionUID = 1L;
	public static final String tableName = "Architect";
	public static final ArchitectModel dao = new ArchitectModel();
	 ...
	 * @return
	 */
	public static Page<ArchitectModel> getList(int pageNumber, int pageSize, String key) {
	 ...
	 * @return
	 */
	public static ArchitectModel getById(String id) {
	 ...
	 * 
	 * @Title: save 
	 * @Description:保存，这里是以分别参数传下来的，还可以用对象的信息传下来  
	 * @param 
	 * @return 参数 
	 * @return boolean 返回类型 
	 * @throws
	...
	public static boolean save(String id, String name, String sex, String tel_no, String disclose,
		...
		ArchitectModel model = new ArchitectModel();
	...
	public static boolean update(String id, String name, String sex, String tel_no, String disclose,
			String age,String work_address,String comments,String phone_no,String nation) {
		ArchitectModel model = ArchitectModel.getById(id);
		if (model == null) {
			return false;
		}
		model.setId(StringUtil.getId());
	 ...
	 * @return
	 */
	public static boolean delArchitectById(String id) {
		try {
	 ...
	 public static List<ArchitectModel> findModelbyPhone_no(String phone_no) {
	    	String sql="select * from "+tableName+" where phone_no = ?";
	    	List<ArchitectModel> list= dao.find(sql,phone_no);
	    	return list;
	    }
	 public static List<ArchitectModel> getListAll() {
