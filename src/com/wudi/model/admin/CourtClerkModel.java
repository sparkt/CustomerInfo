 ...
 *
 */
public class CourtClerkModel extends Model<CourtClerkModel> {
	private static final long serialVersionUID = 1L;
	public static final String tableName = "CourtClerk";
	public static final CourtClerkModel dao = new CourtClerkModel();
	 ...
	 * @return
	 */
	public static Page<CourtClerkModel> getList(int pageNumber, int pageSize, String key) {
	 ...
	 * @return
	 */
	public static CourtClerkModel getById(String id) {
	...
	public static boolean save(String id, String name, String sex, String tel_no, String disclose,
		...
		CourtClerkModel model = new CourtClerkModel();
	...
	public static boolean update(String id, String name, String sex, String tel_no, String disclose,
			String age,String work_address,String comments,String phone_no,String nation) {
		CourtClerkModel model = CourtClerkModel.getById(id);
		if (model == null) {
			return false;
		}
		model.setId(StringUtil.getId());
	 ...
	 * @return
	 */
	public static boolean delCourtClerkById(String id) {
		try {
	 ...
	 public static List<CourtClerkModel> findModelbyPhone_no(String phone_no) {
	    	String sql="select * from "+tableName+" where phone_no = ?";
	    	List<CourtClerkModel> list= dao.find(sql,phone_no);
	    	return list;
	    }
	 public static List<CourtClerkModel> getListAll() {
