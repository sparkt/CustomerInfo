 ...
 *
 */
public class UndergraduateModel extends Model<UndergraduateModel> {
	private static final long serialVersionUID = 1L;
	public static final String tableName = "Undergraduate";
	public static final UndergraduateModel dao = new UndergraduateModel();
	 ...
	 * @return
	 */
	public static Page<UndergraduateModel> getList(int pageNumber, int pageSize, String key) {
	 ...
	 * @return
	 */
	public static UndergraduateModel getById(String id) {
	...
	public static boolean update(String id, String name, String sex, String tel_no, String disclose,
			String age,String work_address,String comments,String phone_no,String nation) {
		UndergraduateModel model = UndergraduateModel.getById(id);
		if (model == null) {
			return false;
		}
		model.setId(StringUtil.getId());
	 ...
	 * @return
	 */
	public static boolean delUndergraduateById(String id) {
		try {
	 ...
	 public static List<UndergraduateModel> findModelbyPhone_no(String phone_no) {
	    	String sql="select * from "+tableName+" where phone_no = ?";
	    	List<UndergraduateModel> list= dao.find(sql,phone_no);
	    	return list;
	    }
	 public static List<UndergraduateModel> getListAll() {
