 ...
 *
 */
public class AccountingModel extends Model<AccountingModel> {
	private static final long serialVersionUID = 1L;
	public static final String tableName = "Accounting";
	public static final AccountingModel dao = new AccountingModel();
	 ...
	 * @return
	 */
	public static Page<AccountingModel> getList(int pageNumber, int pageSize, String key) {
	 ...
	 * @return
	 */
	public static AccountingModel getById(String id) {
	...
	public static boolean update(String id, String name, String sex, String tel_no, String disclose,
			String age,String work_address,String comments,String phone_no,String nation) {
		AccountingModel model = AccountingModel.getById(id);
		if (model == null) {
			return false;
		}
		model.setId(StringUtil.getId());
	 ...
	 * @return
	 */
	public static boolean delAccountingById(String id) {
		try {
	 ...
	 public static List<AccountingModel> findModelbyPhone_no(String phone_no) {
	    	String sql="select * from "+tableName+" where phone_no = ?";
	    	List<AccountingModel> list= dao.find(sql,phone_no);
	    	return list;
	    }
	 public static List<AccountingModel> getListAll() {
